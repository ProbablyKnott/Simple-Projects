...
#TODO: 
#Pass buttonNum as a parameter and get rid of 2-9 button defs
...
def main():
	...
	button1 = Button(frame2, text="1", command = lambda: buttonOne(whichNum))
	button1.grid(column=0, row=2)
	button2 = Button(frame2, text="2", command = lambda: buttonTwo(whichNum))
	button2.grid(column=1, row=2)
	button3 = Button(frame2, text="3", command = lambda: buttonThree(whichNum))
	button3.grid(column=2, row=2)
	button4 = Button(frame2, text="4", command = lambda: buttonFour(whichNum))
	button4.grid(column=0, row=3)
	button5 = Button(frame2, text="5", command = lambda: buttonFive(whichNum))
	button5.grid(column=1, row=3)
	button6 = Button(frame2, text="6", command = lambda: buttonSix(whichNum))
	button6.grid(column=2, row=3)
	button7 = Button(frame2, text="7", command = lambda: buttonSeven(whichNum))
	button7.grid(column=0, row=4)
	button8 = Button(frame2, text="8", command = lambda: buttonEight(whichNum))
	button8.grid(column=1, row=4)
	button9 = Button(frame2, text="9", command = lambda: buttonNine(whichNum))
